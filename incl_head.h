...
typedef vector<vector<double> > MAT_D; 
	...
	const int word_length=14,space_num=7;
	const int L=7,Lmin=5;
	const int KG1=128,KG2=32,Kopt=7;  // from 00000(means space) 00001(a) ... 11010(z)
	const int J1=KG1*2*L+1,J2=KG2*2*Lmin,Tseq=word_length*L-2*space_num;
	const int update_num=1, Inner_num=30;
