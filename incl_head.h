...
typedef vector<vector<double> > MAT_D; 
	...
	const string word="aa";
	const int word_length=2,space_num=0;
	const int L=6,Lmin=5;
	const int KG=64,Kopt=1;  // from 00000(means space) 00001(a) ... 11010(z)
	...
	const double prefer=0.1,global_prefer=0*prefer/KG/L;
